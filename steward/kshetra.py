...
STEWARD_KSHETRA: Final[dict[PrakritiElement, TattvaMapping]] = {
    ...
    PrakritiElement.SHROTRA: TattvaMapping(
        ...
        module="steward.senses.git_sense",
        component="GitSense",
        role="Hear project history via git (branch, commits, upstream)",
    ),
    PrakritiElement.TVAK: TattvaMapping(
        element=PrakritiElement.TVAK,
        layer=ELEMENT_PROTOCOL_LAYER[PrakritiElement.TVAK],
        module="steward.senses.project_sense",
        component="ProjectSense",
        role="Feel project structure via filesystem (language, dirs, config)",
    ),
    PrakritiElement.CHAKSHUS: TattvaMapping(
        ...
        module="steward.senses.code_sense",
        component="CodeSense",
        role="See code structure via AST (modules, classes, functions)",
    ),
    ...
    PrakritiElement.GHRANA: TattvaMapping(
        ...
        module="steward.senses.health_sense",
        component="HealthSense",
        role="Smell code entropy via file metrics (staleness, size, smells)",
    ),
    # ═══════════════════════════════════════════════════════════════════
