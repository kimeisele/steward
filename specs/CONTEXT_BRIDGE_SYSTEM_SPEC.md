...
| OQ-07 | GESCHLOSSEN, durch Governance Amendment 01 präzisiert: Welche Core-File-, Reviewer- und Diff-Gates schützen `AGENTS.md`, `CLAUDE.md` und die statische Verfassungsquelle? | Evidence-Paket OQ-18/OQ-07 plus `CONTEXT_BRIDGE_GOVERNANCE_AMENDMENT_01.md`; PR-only `main` ohne Automation-Bypass, gebundener Single-Owner-HITL für C0 und Required Contract Check für generierte Root-Ausgaben |
