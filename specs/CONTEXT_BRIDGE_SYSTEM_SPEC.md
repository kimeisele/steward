...
| OQ-07 | GESCHLOSSEN: Welche Core-File-, CODEOWNERS-, Reviewer- und Diff-Gates schützen `AGENTS.md`, `CLAUDE.md` und die statische Verfassungsquelle? | Evidence-Paket OQ-18/OQ-07; PR-only `main` ohne Automation-Bypass, Code-Owner für menschliche Governance und Required Contract Check für generierte Root-Ausgaben |
